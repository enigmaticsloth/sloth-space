      ...
      <div class="ws-header">
        ...
        <div class="ws-header-actions">
          <div class="ws-new-dropdown">
            <button class="ws-new-btn" onclick="wsToggleNewMenu(event)">+ File ▾</button>
            <div class="ws-new-menu" id="wsNewMenu">
              <button class="ws-new-menu-item" onclick="wsNewFile('slide')"><span class="ws-nm-icon"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg></span> Slide</button>
              <button class="ws-new-menu-item" onclick="wsNewFile('doc')"><span class="ws-nm-icon"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg></span> Doc</button>
              <button class="ws-new-menu-item" onclick="wsNewFile('sheet')"><span class="ws-nm-icon"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="3" y1="15" x2="21" y2="15"/><line x1="9" y1="3" x2="9" y2="21"/><line x1="15" y1="3" x2="15" y2="21"/></svg></span> Sheet</button>
          ...
          <button class="ws-new-btn project" onclick="showWsNewProject()" style="font-size:13px;">+ Project</button>
        </div>
      </div>
      ${projectBadge}
      ${navHtml}
